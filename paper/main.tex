...
\title{
  Active map exploration using semantic room prediction in indoor environments
}
\titlerunning{Semantic exploration}
...
\paragraph{Problem Statement}\label{sec:problem}
\input{files/problem}
